package zx.soft.maven.plugins.redis;
...
public class ShutdownRedisMojo extends AbstractMojo {
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		DefaultEventExecutorGroup redisGroup = (DefaultEventExecutorGroup) getPluginContext().get(
				RunRedisMojo.REDIS_GROUP_CONTEXT_PROPERTY_NAME);
